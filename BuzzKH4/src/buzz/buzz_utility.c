...
static int buzz_register_hooks() {
   ...
   /* BuzzStartCharging */
   buzzvm_pushs(VM, buzzvm_string_register(VM, "start_charging", 1));
   buzzvm_pushcc(VM, buzzvm_function_register(VM, BuzzStartCharging));
   buzzvm_gstore(VM);
   /* BuzzStopCharging */
   buzzvm_pushs(VM, buzzvm_string_register(VM, "stop_charging", 1));
   buzzvm_pushcc(VM, buzzvm_function_register(VM, BuzzStopCharging));
   buzzvm_gstore(VM);
   /* BuzzStartProcessing */
   buzzvm_pushs(VM, buzzvm_string_register(VM, "start_processing", 1));
   buzzvm_pushcc(VM, buzzvm_function_register(VM, BuzzStartProcessing));
   buzzvm_gstore(VM);
   /* BuzzStopProcessing */
   buzzvm_pushs(VM, buzzvm_string_register(VM, "stop_processing", 1));
